...
<div class="row">
	  ...
	  <div class="col-md-8 alert alert-success" id="tt" >
               <span id="regsus"></span>
       </div>
       <div class="col-md-2">
                ...
                <div class="reg-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-6">
                             ...
                             <div class="form-group">
                                    <input class="form-control" placeholder="Số CMTND" value="<?php echo $cus['cmt'] ?>" id="reg_cmt" name="cmt" type="text" >
                             </div>
                              <div class="form-group">
                                    <label   id="err_cmt_reg" style="color: red;"></label>
                              </div>
                             <div class="form-group">
                                    <input class="form-control" placeholder="Ngày Cấp" value="<?php echo $cus['cmt_datecreate'] ?>" id="datepicker" name="cmt_date" type="text" >
                             </div>
                              <div class="form-group">
							 ...
							 <div class="form-group">
                                    <input class="form-control" placeholder="Mật khẩu" value="<?php echo $cus['password'] ?>" id="reg_password" name="reg_password" type="password" >
                             </div>
                        </div>
