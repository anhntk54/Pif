...
<div class="row">
   <div class="col-lg-12">
                      ...
                      <h1 class="page-header">Danh sách hợp đồng <a  href="<?php echo Yii::app()->request->baseUrl.'/piadmin/Contract/CreateHD';?>" class="btn btn-success btn-xs">Tạo mới hợp đồng</a></h1>
...
<div class="row">
 <?php if($sus==1){ ?>
   <div class="col-lg-12 alert alert-success">
     <p>Cập nhật hợp đồng thành công.Nhấn <a href="<?php echo Yii::app()->request->baseUrl; ?>/piadmin/Home" title="">tại đây </a> để quay về trang chủ</p>
   </div>
  <?php } ?> 
             ...
             <div >
              <form method="POST" name="filter" action="<?php echo Yii::app()->request->baseUrl; ?>/piadmin/Contract/Filter">
               <div class="row">
                  ...
                  <!--  <div class="col-lg-3">
                        <div class="form-group">
                            <select name="khs" required="" id="khs" class="form-control" onchange="getKHS(this.value)" placeholder="Gõ tên khách hàng">
                       ...
                       <tbody id="listpro" style="font-size: 12px;">
                        ...
                        <?php foreach ($data as $item) { ?>
                          ...
                          " >
                              ...
                              <td class="icon_action text-center">
                              <?php if($item['note']): ?>
                                <a ><i class="fa fa-exclamation-circle" data-toggle="tooltip" data-placement="top" title="<?php echo $item['note'] ?>"></i>
                              <?php endif; ?></a>
                              </td>
